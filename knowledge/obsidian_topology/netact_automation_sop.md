...
demo_password `Content-Type`: `application/json`
...
```json
{
  "name": "IPTV",
  "nodes": [
    {"id": "node_1", "type": "Backup_Verify", "data": {"device": "CORE-SW-01"}},
    {"id": "node_2", "type": "CLI_Command", "data": {"device": "CORE-SW-01", "command": "interface GigabitEthernet0/1\nshutdown"}}
  ],
  "edges": [
